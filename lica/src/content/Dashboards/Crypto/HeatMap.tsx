...
import { Button, Card, Grid, Box, CardContent, Typography, Avatar, alpha, Tooltip, CardActionArea, styled, MenuItem, InputLabel, FormControl, CardHeader } from '@mui/material';
...
import AddTwoToneIcon from '@mui/icons-material/AddTwoTone';
  ...
  function HeatMap() {
    useEffect(() => {
        ...
        heatmap.setData({
            max: 25,
            data: [{ x: 165, y: 200, value: 5}, { x: 160, y: 250, value: 4}, { x: 150, y: 260, value: 5}, { x: 100, y: 270, value: 5}, 
                { x: 165, y: 250, value: 5}, { x: 160, y: 255, value: 4}, { x: 150, y: 265, value: 5}, { x: 150, y: 275, value: 5}, 
                { x: 100, y: 20, value: 5}, { x: 100, y: 30, value: 4}, { x: 100, y: 40, value: 5}, { x: 105, y: 50, value: 5},
                ...
                <Card>
                    ...
                    <Box display="flex" alignItems="center">
                        <Box display="flex" alignItems="center" justifyContent="space-between" flex={1}>
                            <Typography variant="h3" sx={{ mt: 2, ml: 2}}>HeatMap</Typography>
                            <Box />
                            <Box component="div">
                            <FormControl variant="standard" sx={{ m: 1, minWidth: 200 }}>
                                <InputLabel id="store-select">Store</InputLabel>
                                    <Select labelId="store-select" id = "store" value={store} label="Store" onChange={handleChange}>
                                ...
                                <FormControl variant="standard" sx={{ m: 1, minWidth: 200 }}>
                                    ...
                                    <Select labelId="floor-select" id = "floor" value={floor} label="Floor" onChange={handleChange}>
                                        <MenuItem value="">None</MenuItem>
